...
func TestRoundHalfUp(t *testing.T) {
	...
	assert.Equal(t, 10, rnd(ctx, 10, 1))
	assert.Equal(t, 10, rnd(ctx, 11, 1))
	assert.Equal(t, 20, rnd(ctx, 15, 1))
	assert.Equal(t, 20, rnd(ctx, 19, 1))
	assert.Equal(t, 200, rnd(ctx, 249, 10))
	assert.Equal(t, 300, rnd(ctx, 250, 10))
	assert.Equal(t, 300, rnd(ctx, 251, 10))
	assert.Equal(t, 300, rnd(ctx, 299, 10))
	assert.Equal(t, 300, rnd(ctx, 300, 10))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1000000000000000, 100000000000000))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1100000000000000, 100000000000000))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1499999999999999, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 1500000000000000, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 1500000000000001, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 1900000000000000, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 1999999999999999, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 2000000000000000, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 2499999999999999, 100000000000000))
	assert.Equal(t, 3000000000000000, rnd(ctx, 2500000000000000, 100000000000000))
	assert.Equal(t, 3000000000000000, rnd(ctx, 2500000000000001, 100000000000000))
	assert.Equal(t, 3000000000000000, rnd(ctx, 2999999999999999, 100000000000000))
	assert.Equal(t, 3000000000000000, rnd(ctx, 3000000000000000, 100000000000000))
}
...
func TestRoundHalfEven(t *testing.T) {
	...
	assert.Equal(t, 20, rnd(ctx, 19, 1))
	assert.Equal(t, 200, rnd(ctx, 249, 10))
	assert.Equal(t, 200, rnd(ctx, 250, 10))
	assert.Equal(t, 300, rnd(ctx, 251, 10))
	assert.Equal(t, 300, rnd(ctx, 299, 10))
	assert.Equal(t, 300, rnd(ctx, 300, 10))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1000000000000000, 100000000000000))
	...
	assert.Equal(t, 2000000000000000, rnd(ctx, 2000000000000000, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 2499999999999999, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 2500000000000000, 100000000000000))
	assert.Equal(t, 3000000000000000, rnd(ctx, 2500000000000001, 100000000000000))
	assert.Equal(t, 3000000000000000, rnd(ctx, 2999999999999999, 100000000000000))
	assert.Equal(t, 3000000000000000, rnd(ctx, 3000000000000000, 100000000000000))
}
...
func TestRoundHDown(t *testing.T) {
	...
	assert.Equal(t, 10, rnd(ctx, 10, 1))
	assert.Equal(t, 10, rnd(ctx, 11, 1))
	assert.Equal(t, 10, rnd(ctx, 15, 1))
	assert.Equal(t, 10, rnd(ctx, 19, 1))
	assert.Equal(t, 200, rnd(ctx, 249, 10))
	assert.Equal(t, 200, rnd(ctx, 250, 10))
	assert.Equal(t, 200, rnd(ctx, 251, 10))
	assert.Equal(t, 200, rnd(ctx, 299, 10))
	assert.Equal(t, 300, rnd(ctx, 300, 10))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1000000000000000, 100000000000000))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1100000000000000, 100000000000000))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1499999999999999, 100000000000000))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1500000000000000, 100000000000000))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1500000000000001, 100000000000000))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1900000000000000, 100000000000000))
	assert.Equal(t, 1000000000000000, rnd(ctx, 1999999999999999, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 2000000000000000, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 2499999999999999, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 2500000000000000, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 2500000000000001, 100000000000000))
	assert.Equal(t, 2000000000000000, rnd(ctx, 2999999999999999, 100000000000000))
	assert.Equal(t, 3000000000000000, rnd(ctx, 3000000000000000, 100000000000000))
}
